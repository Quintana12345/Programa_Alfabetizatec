...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-01-2025 a las 19:46:10
...
(1, 17, 'Estudiante', 'Servicio Social Comunitario', 12345678, 101, 44, 6),
(6, 16, 'Docente', 'Servicio Social Comunitario', NULL, NULL, 43, NULL),
(7, 25, 'externo', 'participacion_honorifica', 0, 0, 0, 0),
(8, 26, 'externo', 'participacion_honorifica', 0, 0, 0, 0),
(9, 27, 'externo', 'participacion_honorifica', 0, 0, 0, 0),
(10, 28, 'docente', 'creditos_complementarios', 0, 0, 0, 0);
...
(1, 'Juan', 'Pérez López', 'Calle 123, Colonia Centro, Ciudad de México', 'PELO920304HDFRRN01', 5551234567, 'juan.perez@example.com'),
(2, 'María', 'González Ramírez', 'Av. Reforma 456, Guadalajara, Jalisco', 'GORM850615MJCLZR05', 5559876543, 'maria.gonzalez@example.com'),
(3, 'Carlos', 'López Martínez', 'Calle Insurgentes 789, Monterrey, Nuevo León', 'LOMC960720HNLPRL08', 5556543210, 'carlos.lopez@example.com'),
(4, 'Antonio', 'Ramírez Díaz', 'Calle Real 456, Ciudad de México', 'RAMA920603HDFMRZ05', 5552233445, 'antonio.ramirez@example.com');
...
(1, 'Aprende a leer y escribir II', 'Programa para aprender a leer y escribir', 44, 1, 25, 1, '2025-01-01', '2025-01-30'),
(2, 'Ingeniería en Sistemas Computacionales', 'Programa de Ingeniería enfocado en el desarrollo de software y sistemas informáticos.', 43, 2, 200, 1, '2025-01-01', '2025-12-31'),
(3, 'Curso de Inglés Básico', 'Programa para aprender inglés básico', 43, 3, 100, 1, '2025-02-01', '2025-06-30');
...
(1, 'Aprobado', 1, 1, '2025-01-16'),
(2, 'Desaprobado', 2, 3, '2024-01-01'),
(3, 'Aprobado', 1, 2, '2025-01-20'),
(4, 'Aprobado', 3, 4, '2025-01-20');
...
(23, 'Instituto Tecnológico de Chihuahua', 6, 'Escolarizada', 'nadie', 'lol'),
...
(44, 'Instituto Tecnológico de La Laguna', 8, 'Escolarizada', 'yo', 'Federal'),
...
(16, 'Juan', 'Pérez', NULL, 5551234567, 'juan.perez@example.com', 'juan.perez@instituto.edu.mx', '$2y$10$HJPzB8MACBrRUH2Uq1qYi.4ERWQZsu1NgqKxzJ0aUAmmTKj7cJmHa', 4, NULL),
(17, 'María', 'González', NULL, 5559876543, 'maria.gonzalez@example.com', 'maria.gonzalez@instituto.edu.mx', '$2y$10$HJPzB8MACBrRUH2Uq1qYi.4ERWQZsu1NgqKxzJ0aUAmmTKj7cJmHa', 4, NULL),
(18, 'Yimmi', 'Quintana', NULL, 5556543210, 'yimmi.quintan@example.com', '', '$2y$10$2SocfeplfsIDCl.VVEbWceuSFkO4E68hX4C1gGC0hX1PUXuGsRt7W', 3, NULL),
(19, 'Ramón ', 'Jiménez López', NULL, 5554567890, 'ramon.jimenez_lopez@example.com', NULL, '$2y$10$2SocfeplfsIDCl.VVEbWceuSFkO4E68hX4C1gGC0hX1PUXuGsRt7W', 1, NULL),
(20, 'Victor Hugo', 'Agaton Catalan', NULL, 5558765432, 'hugo.agaton@example.com', NULL, '$2y$10$HJPzB8MACBrRUH2Uq1qYi.4ERWQZsu1NgqKxzJ0aUAmmTKj7cJmHa', 2, NULL),
(25, 'elieze', 'apaa', 'SOME001120HGRLRLA2', 1212121212121, 'yimmi.quintan@gem.com', '', '$2y$10$h4fgqHwEBcWPz60KEGhm8.Y4o8yN4Q/Iad9nt8rnVf3auepNyU5lq', 4, 'Developeer'),
(26, 'elieze', 'sol', 'SOME001120HGRLRLA2', 11232132131212, 'yimmi.quintan@mail.com', '', '$2y$10$RK.O/rOibsz24QpngiNo4OT4/quHNRZOwETifWtEeqXKPj6jYp9LK', 4, 'devv'),
(27, 'elieze', 'sol', 'SOME001120HGRLRLA2', 11232132131212, 'yimmi.quintan@mail.com', '', '$2y$10$.WLBV1OFdaqQk9kBN6rTF.d1GL5DUJwnG.NaUGebXGVUoemponCi6', 4, 'devv'),
(28, 'chauu', 'dad', 'SOME001120HGRLRLA2', 987654321, 'adriana.silva@gmail.com', '', '$2y$10$bADQrYDvKpEuPbObnE5hs.JTxQBry9FKfVNozvKvOpKRVBg0/GwWG', 4, 'sales');
