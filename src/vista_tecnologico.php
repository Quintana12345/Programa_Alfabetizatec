...
if ($id_tecnologico) {
    ...
    // Consultar los participantes relacionados con el tecnológico
    $consulta_participantes = "SELECT * FROM participantes WHERE instituto_id = " . intval($id_tecnologico);
    $resultado_participantes = $conn->query($consulta_participantes);
} else {
...
<body>
    ...
    <div class="content">
        <div class="card">
            <img src="<?php echo $tecnologico['imagen']; ?>" alt="Logo">
            <div class="lado_izq">
                <h1><?php echo $tecnologico['nombre']; ?></h1>
                <h3>Detalles</h3>
                <p>Estado: <?php echo $tecnologico['estado']; ?></p>
        ...
        <div class="form-container">
            ...
            <table id="tabla-participantes" class="display">
                ...
                <tbody>
                    <?php
                    if ($resultado_participantes && $resultado_participantes->num_rows > 0) {
                        while ($participante = $resultado_participantes->fetch_assoc()) {
                            ...
                            echo "<td>{$participante['direccion']}</td>";
                            echo "<td>{$participante['tipo_participante']}</td>";
                            echo "<td>{$participante['modalidad_participacion']}</td>";
                            echo "</tr>";
                        }
                    }   
                    ?>
